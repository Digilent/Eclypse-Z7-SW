...
#define UART_ID XPAR_UART0_BASEADDR
#define DMA_ID XPAR_XAXIDMA_0_BASEADDR
#define DMA_BURST_SIZE XPAR_ZMODAWG_PORTB_MM2SDMATRANSFER_0_AXI_DMA_0_MM2S_BURST_SIZE
#define DMA_DATA_WIDTH XPAR_ZMODAWG_PORTB_MM2SDMATRANSFER_0_AXI_DMA_0_MM2S_DATA_WIDTH
#define SINK_BASEADDR XPAR_ZMODAWG_PORTB_AXISTREAMSINKMONITOR_0_AXISTREAMSINKMONITOR_0_BASEADDR
#define SWITCH_SINK_VOID 1
#define SWITCH_SINK_ZMODAWG 0
#define AWG_BASEADDR XPAR_ZMODAWG_PORTB_ZMODAWGFRONTEND_0_ZMODAWGAXICONFIGURAT_0_BASEADDR
#define AWG_PORT XPAR_ZMODAWG_PORTB_MM2SDMATRANSFER_0_AXI_DMA_0_INCLUDE_MM2S
